...
class crawler():
    def __init__(self):
        ...
        self.file_name = "raw_data/gcc.json"
        self.baseurl = 'https://gcc.gnu.org/bugzilla/show_bug.cgi?ctype=xml&id='
        self.first_url = "https://gcc.gnu.org/bugzilla/buglist.cgi?bug_status=UNCONFIRMED&bug_status=NEW&bug_status=ASSIGNED&bug_status=SUSPENDED&bug_status=WAITING&bug_status=REOPENED&field0-0-0=creation_ts&limit=0&no_redirect=1&order=bug_status%2Cpriority%2Cassigned_to%2Cbug_id&query_format=advanced&type0-0-0=substring&value0-0-0="
        self.all_bugs_info = []
        self.info_lock = Lock()
